...
urlpatterns = [
    ...
    path('Articole/', views.posts, name='articles.html'),
    path('Blog/Articole/', views.posts, name='articles.html'),
    path('Publica-articol/', views.blog_post, name='base.html'),
    path('Blog/Publica-articol/', views.blog_post, name='base.html'),
